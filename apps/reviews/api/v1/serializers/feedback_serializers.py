# apps/reviews/api/v1/serializers/feedback_serializers.py
"""
Serializers for feedback models
"""
...
class FeedbackRequestSerializer(BaseTenantSerializer, BaseStatusSerializer):
    """
    ...
    class Meta:
        ...
        fields = [
            ...
            'subject', 'subject_name', 'subject_email',
            'reviewer', 'reviewer_name', 'reviewer_email',
            'requested_by', 'requested_by_name',
            'reviewer_type', 'reviewer_type_display',
            'is_anonymous', 'is_required',
            'status', 'status_display',
            'requested_at', 'due_date', 'reminder_sent_at', 'completed_at',
            'is_overdue', 'has_response',
...
class FeedbackResponseSerializer(BaseTenantSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'suggestions', 'additional_comments', 'ratings',
            'reviewer_name', 'reviewer_type', 'reviewer_type_display',
            'subject_name', 'is_anonymous_response',
...
class FeedbackResponseSubmitSerializer(serializers.Serializer):
    """
    Serializer for submitting feedback response.
    """
...
class FeedbackSummarySerializer(BaseTenantSerializer):
    """
    Serializer for FeedbackSummary model.
    """
    ...
    class Meta:
        ...
        fields = [
            ...
            'subject', 'subject_name', 'subject_email',
            'total_responses',
            'avg_manager_rating', 'avg_peer_rating',
            'avg_subordinate_rating', 'avg_cross_dept_rating',
            'overall_avg_rating',
...
class FeedbackSummaryShareSerializer(serializers.Serializer):
    """
    Serializer for sharing feedback summary.
    """
