# apps/reviews/api/v1/serializers/final_rating_serializers.py
"""
Serializers for FinalRating model
"""
...
from .assessment_serializers import SupervisorReviewSerializer


class FinalRatingSerializer(BaseTenantSerializer):
    """
    Main serializer for FinalRating model.
    """
    ...
    class Meta:
        ...
        fields = [
            ...
            'supervisor_review', 'calibration_session',
            'rating_scale', 'rating_scale_name',
            'kpi_score', 'competency_score', 'mission_score',
            'task_score', 'feedback_score',
            'raw_total_score', 'coefficient_applied', 'adjusted_score',
            'calibration_adjustment', 'calibration_adjustment_reason',
            'final_score', 'final_rating_label', 'final_rating_color',
            'promotion_recommended', 'promotion_target_role', 'promotion_timeline',
            'bonus_amount', 'bonus_percentage',
            'pip_recommended', 'pip_reason',
            'action_outcome', 'action_outcome_display',
...
class FinalRatingListSerializer(FinalRatingSerializer):
    ...
    class Meta(FinalRatingSerializer.Meta):
        fields = [
            ...
            'review_cycle_name', 'final_score', 'final_rating_label',
            'final_rating_color', 'status', 'status_display',
...
class FinalRatingDetailSerializer(FinalRatingSerializer):
    ...
    supervisor_review_data = SupervisorReviewSerializer(
    ...
    def get_score_breakdown(self, obj):
        ...
        return {
            ...
            'feedback': float(obj.feedback_score) if obj.feedback_score else None,
    ...
    class Meta(FinalRatingSerializer.Meta):
        fields = FinalRatingSerializer.Meta.fields + [
            'supervisor_review_data', 'score_breakdown'
        ]


class FinalRatingApproveSerializer(serializers.Serializer):
    """
    Serializer for approving final rating.
    """
...
class FinalRatingLockSerializer(serializers.Serializer):
    """
    Serializer for locking final rating.
    """
...
class FinalRatingCalibrateSerializer(serializers.Serializer):
    """
    Serializer for calibration adjustment.
    """
...
class FinalRatingExportSerializer(serializers.Serializer):
    """
    Serializer for exporting final ratings.
    """
    ...
    def validate_cycle_id(self, value):
        ...
        try:
            ReviewCycle.objects.get(id=value)
...
class RatingDistributionSerializer(serializers.Serializer):
    ...
    class Meta:
        fields = ['rating_label', 'count', 'percentage', 'color']