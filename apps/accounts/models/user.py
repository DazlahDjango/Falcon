...
class User(BaseModel, AbstractUser, PermissionsMixin):
    ...
    phone = models.CharField(_('phone number'), max_length=20, blank=True, validators=[RegexValidator(r'^\+?1?\d{9,15}$', 'Enter valid phone number')])
    ...
    # depatment = models.ForeignKey('structure.Department', on_delete=models.SET_NULL, null=True, blank=True, related_name='members', verbose_name=_('department'))
    ...
    class Meta:
        ...
        # unique_together = [['email', 'tenant_id']] # Unique email per tenant
    ...
    def enable_mfa(self, secret, backup_codes=None):
        ...
        self.save(update_fields=['mfa_enabled', 'mfa_secret', 'backup_codes'])
