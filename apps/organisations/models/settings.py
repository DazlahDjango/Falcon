...
class OrganisationSettings(BaseModel):
    ...
    theme_color = models.CharField(max_length=7, default="#3B82F6", help_text="Primary Hex color code")
    secondary_color = models.CharField(max_length=7, default="#10B981", help_text="Secondary Hex color code")
    accent_color = models.CharField(max_length=7, default="#F59E0B", help_text="Accent Hex color code")
    
    # Localization & Regional
    from timezone_field import TimeZoneField
    timezone = TimeZoneField(default='UTC')
    language = models.CharField(max_length=10, default='en', help_text="Default system language (ISO code)")
    currency = models.CharField(max_length=3, default='USD', help_text="Default currency code (e.g., USD, KES, EUR)")
    ...
    # Data validation
    data_entry_deadline_day = models.PositiveSmallIntegerField(default=5, help_text="Day of month for data entry deadline")
    auto_approve_after_days = models.PositiveSmallIntegerField(null=True, blank=True)
    
    # Notification preferences
    notification_preferences = models.JSONField(default=dict)
    
    # Fiscal & Operational
    fiscal_year_start = models.PositiveSmallIntegerField(default=1, help_text="Month the fiscal year starts (1-12)")
    max_users = models.PositiveIntegerField(default=10)
    is_onboarding_complete = models.BooleanField(default=False)
    
    # Default templates
    default_kpi_template = models.CharField(max_length=100, blank=True, help_text="Default KPI template for new users")
