...
class Organisation(BaseModel):
    ...
    is_verified = models.BooleanField(default=False, help_text="Whether the organisation has been verified by an admin")
    is_demo = models.BooleanField(default=False, help_text="Is this a demo account?")
    
    # Legal & Registration
    registration_number = models.CharField(max_length=100, blank=True, null=True, help_text="Legal registration number")
    tax_id = models.CharField(max_length=100, blank=True, null=True, help_text="Tax identification number (VAT/PIN)")
    
    # Contact Information
    website = models.URLField(max_length=255, blank=True, null=True)
    contact_email = models.EmailField(max_length=255, blank=True, null=True, help_text="Primary contact email")
    contact_phone = models.CharField(max_length=50, blank=True, null=True, help_text="Primary contact phone number")
    ...
    # Falcon internal
    notes = models.TextField(blank=True, help_text="Internal notes for Falcon staff")
    ...
    def has_feature(self, feature_name):
        ...
        if hasattr(self, 'feature_flags'):
            flags = {flag.feature_name: flag.is_enabled for flag in self.feature_flags.all()}
