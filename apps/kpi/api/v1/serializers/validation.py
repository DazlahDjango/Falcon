...
class ValidationRecordSerializer(TenantAwareSerializer):
    ...
    validated_by_email = serializers.EmailField(source='validated_by.email', read_only=True, default=None)
    ...
    rejection_reason_text = serializers.CharField(source='rejection_reason.reason', read_only=True, default=None)
