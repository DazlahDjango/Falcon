...
class KpiSettingsService:
    ...
    def get_record(cls) -> KpiSystemSettings:
        record, _ = KpiSystemSettings.objects.get_or_create(
    ...
    @classmethod
    @transaction.atomic
    def update_settings(cls, patch: dict, user_id=None) -> KpiSystemSettings:
        record = cls.get_record()
    ...
    @classmethod
    def reset_to_defaults(cls, user_id=None) -> KpiSystemSettings:
