...
class EmploymentFilter(filters.FilterSet):
    ...
    division_id = filters.UUIDFilter(field_name='position__division_id')
    division_code = filters.CharFilter(field_name='position__division__code', lookup_expr='iexact')
    department_id = filters.UUIDFilter(field_name='position__department_id')
    department_code = filters.CharFilter(field_name='position__department__code', lookup_expr='iexact')
    section_id = filters.UUIDFilter(field_name='position__section_id')
    section_code = filters.CharFilter(field_name='position__section__code', lookup_expr='iexact')
    unit_id = filters.UUIDFilter(field_name='position__unit_id')
    unit_code = filters.CharFilter(field_name='position__unit__code', lookup_expr='iexact')
    ...
    class Meta:
        model = Employment
        fields = [
            'id', 'user_id', 'position_id', 'division_id', 'department_id',
            'section_id', 'unit_id', 'employment_type', 'is_current',
...
class EmploymentCurrentFilter(filters.FilterSet):
    ...
    class Meta:
        model = Employment
        fields = ['user_id', 'division_id', 'department_id', 'section_id', 'unit_id', 'is_manager', 'is_executive']
