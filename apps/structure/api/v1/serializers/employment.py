...
class EmploymentDetailSerializer(BaseStructureDetailSerializer):
    ...
    unit_code = serializers.CharField(source='position.unit.code', read_only=True, allow_null=True)
    unit_name = serializers.CharField(source='position.unit.name', read_only=True, allow_null=True)
    division_id = serializers.UUIDField(source='position.division_id', read_only=True, allow_null=True)
    department_id = serializers.UUIDField(source='position.department_id', read_only=True, allow_null=True)
    section_id = serializers.UUIDField(source='position.section_id', read_only=True, allow_null=True)
    unit_id = serializers.UUIDField(source='position.unit_id', read_only=True, allow_null=True)
    manager_user_id = serializers.UUIDField(read_only=True)
