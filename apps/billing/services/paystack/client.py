...
from ...exceptions import (
    ...
    PaymentInitializationError, PaymentVerificationError
)
...
class PayStackClient:
    ...
    def _request(self, method: str, endpoint: str, data: Optional[Dict] = None, 
        ...
        try:
            ...
            if not response_data.get('status'):
                ...
                raise APIError(
                    f"PayStack error: {error_message}",
    ...
    def initialize_transaction(self, email: str, amount: int, reference: Optional[str] = None,
                                callback_url: Optional[str] = None, metadata: Optional[Dict] = None,
    ...
    def create_customer(self, email: str, first_name: Optional[str] = None,
                       last_name: Optional[str] = None, phone: Optional[str] = None) -> Dict[str, Any]:
        data = {'email': email}
    ...
    def create_refund(self, transaction_reference: str, amount: Optional[int] = None,
