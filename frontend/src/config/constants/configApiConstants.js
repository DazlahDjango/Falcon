...
export const CONFIG_API = {
    ...
    SYNC_REGISTRY: `${API_BASE}/config/registered-apps/sync_registry/`,
    REGISTRY_DEFINITIONS: `${API_BASE}/config/registered-apps/definitions/`,
    ...
    // System Settings
    SYSTEM_SETTINGS: `${API_BASE}/config/system-settings/`,
    SYSTEM_SETTINGS_RESET: `${API_BASE}/config/system-settings/reset/`,
