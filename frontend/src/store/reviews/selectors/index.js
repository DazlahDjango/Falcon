...
export const selectRatingScalesPagination = (state) => selectRatingScalesState(state).pagination;
...
export const selectCompetenciesPagination = (state) => selectCompetenciesState(state).pagination;
export const selectCompetenciesFilters = (state) => selectCompetenciesState(state).filters;
...
export const selectPIPsPagination = (state) => selectPIPsState(state).pagination;
...
export const selectCoefficientsState = (state) => state.reviews.coefficients;
export const selectAllCoefficients = (state) => selectCoefficientsState(state).items;
export const selectCoefficientById = (state, id) =>
  selectAllCoefficients(state).find((item) => item.id === id);
export const selectSelectedCoefficient = (state) => selectCoefficientsState(state).selectedItem;
export const selectCoefficientsLoading = (state) => selectCoefficientsState(state).loading;
export const selectCoefficientsError = (state) => selectCoefficientsState(state).error;
export const selectActiveCoefficientsList = (state) => selectCoefficientsState(state).activeCoefficients;
export const selectApplyResult = (state) => selectCoefficientsState(state).applyResult;
...
export const selectPromotionsPagination = (state) => selectPromotionsState(state).pagination;
