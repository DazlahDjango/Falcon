...
const useKPIPermissions = () => {
    ...
    const permissionsData = useMemo(() => {
        ...
        const permissions = {
            ...
            canCreateFramework: isClientAdmin || isSuperAdmin || isExecutive,
            canCreateSector: isClientAdmin || isSuperAdmin || isExecutive,
            canCreateCategory: isClientAdmin || isSuperAdmin || isExecutive,
            canCreateTemplate: isClientAdmin || isSuperAdmin || isExecutive,
            ...
            canUpdateFramework: isClientAdmin || isSuperAdmin || isExecutive,
            canUpdateSector: isClientAdmin || isSuperAdmin || isExecutive,
            canUpdateCategory: isClientAdmin || isSuperAdmin || isExecutive,
            canUpdateTemplate: isClientAdmin || isSuperAdmin || isExecutive,
            canUpdateTarget: isAuthenticated,
            canUpdateActual: isAuthenticated,

            // Delete permissions
            canDeleteKPI: isClientAdmin || isSuperAdmin,
            canDeleteFramework: isClientAdmin || isSuperAdmin || isExecutive,
            canDeleteSector: isClientAdmin || isSuperAdmin || isExecutive,
            canDeleteCategory: isClientAdmin || isSuperAdmin || isExecutive,
            canDeleteTemplate: isClientAdmin || isSuperAdmin || isExecutive,
