...
import { FiEdit, FiTrash2, FiTrendingUp, FiTrendingDown, FiMinus, FiShare2, FiCalendar } from 'react-icons/fi';
import { FolderTree } from 'lucide-react';
import KPIStatusBadge from '../../common/KPIStatusBadge';

const TargetTable = ({ targets, onRowClick, onEdit, onDelete, onCascade, onViewTree, onPhase, canEdit, canDelete, canCascade }) => {
