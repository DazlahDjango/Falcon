        ...
        <div className="detail-section" style={{ marginTop: '24px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            <div>
              ...
              <p style={{ margin: '4px 0 0 0', fontSize: '13px', color: 'var(--text-secondary, #64748b)' }}>
                Staff members directly assigned to this section.
              </p>
            </div>
          </div>
          ...
          {currentItem.staff && currentItem.staff.length > 0 ? (
            ...
            <div style={{
              ...
              <p style={{ color: 'var(--text-secondary, #64748b)', margin: 0, fontSize: '13px' }}>No direct staff assigned at this section level.</p>
            </div>
          )}
        </div>
