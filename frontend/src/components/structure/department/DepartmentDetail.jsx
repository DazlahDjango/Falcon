    ...
    <div className="department-detail-container">
      ...
      <div className="department-detail-body">
        ...
        <div className="detail-section" style={{ marginTop: '24px' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px' }}>
            <div>
              <h3 style={{ margin: 0, fontSize: '18px' }}>Direct Staff & Team Members ({currentItem.staff?.length || 0})</h3>
              <p style={{ margin: '4px 0 0 0', fontSize: '13px', color: 'var(--text-secondary, #64748b)' }}>
                Staff members directly assigned to this department.
              </p>
            </div>
          </div>
          ...
          {currentItem.staff && currentItem.staff.length > 0 ? (
                ...
                >
                  ...
                  <div style={{ overflow: 'hidden', flex: 1 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                      ...
                      {member.is_manager && !member.is_executive && <span style={{ fontSize: '10px', background: '#dbeafe', color: '#1d4ed8', padding: '1px 6px', borderRadius: '4px', fontWeight: 600 }}>Head</span>}
                    </div>
            ...
            <div style={{
              ...
              <p style={{ color: 'var(--text-secondary, #64748b)', margin: 0, fontSize: '13px' }}>No direct staff assigned at this department level.</p>
            </div>
          )}
        </div>
