(fasc) PS C:\Users\Dazlah Administrator\Desktop\Forward\Falcon> python manage.py show_urls | Select-String "accounts"
{"time": "2026-07-27 12:20:04,846", "level": "INFO", "module": "apps", "message": "AXES: BEGIN version 8.3.1, blocking by combination of username and ip_address and user_agent"}
...
{"time": "2026-07-27 12:20:06,863", "level": "INFO", "module": "connection_cleanup", "message": "Cleaned up 2 stale database connection records on startup."}
{"time": "2026-07-27 12:20:06,864", "level": "INFO", "module": "connection_service", "message": "Pre-warming connection pool..."}
{"time": "2026-07-27 12:20:06,891", "level": "DEBUG", "module": "connection_service", "message": "Getting connection for organization: c732f915-34d1-489d-8551-3c71bf92a372 (read_only: False)"}
{"time": "2026-07-27 12:20:06,904", "level": "INFO", "module": "connection_service", "message": "Creating connection for organization: c732f915-34d1-489d-8551-3c71bf92a372 (read_only: False)"}
{"time": "2026-07-27 12:20:06,941", "level": "DEBUG", "module": "connection_service", "message": "Getting connection for organization: 8335eb40-dbc1-47cf-9305-d48051b90b78 (read_only: False)"}
{"time": "2026-07-27 12:20:06,952", "level": "INFO", "module": "connection_service", "message": "Creating connection for organization: 8335eb40-dbc1-47cf-9305-d48051b90b78 (read_only: False)"}
{"time": "2026-07-27 12:20:06,963", "level": "INFO", "module": "connection_cleanup", "message": "Pre-warmed 2 tenant database connections during scheduler startup."}
{"time": "2026-07-27 12:20:06,967", "level": "INFO", "module": "connection_cleanup", "message": "Connection cleanup scheduler started (interval: 60s, idle timeout: 30m)"}
{"time": "2026-07-27 12:20:07,388", "level": "INFO", "module": "apps", "message": "Dashboard critical caches warmed"}
{"time": "2026-07-27 12:20:08,415", "level": "DEBUG", "module": "__init__", "message": "matplotlib data path: C:\\Users\\Dazlah Administrator\\Desktop\\Forward\\Falcon\\fasc\\Lib\\site-packages\\matplotlib\\mpl-data"}
{"time": "2026-07-27 12:20:08,536", "level": "DEBUG", "module": "__init__", "message": "CONFIGDIR=C:\\Users\\Dazlah Administrator\\.matplotlib"}
{"time": "2026-07-27 12:20:08,543", "level": "DEBUG", "module": "__init__", "message": "interactive is False"}
{"time": "2026-07-27 12:20:08,546", "level": "DEBUG", "module": "__init__", "message": "platform is win32"}
{"time": "2026-07-27 12:20:08,636", "level": "DEBUG", "module": "__init__", "message": "CACHEDIR=C:\\Users\\Dazlah Administrator\\.matplotlib"}
{"time": "2026-07-27 12:20:08,656", "level": "DEBUG", "module": "font_manager", "message": "Using fontManager instance from C:\\Users\\Dazlah Administrator\\.matplotlib\\fontlist-v3.11.0.json"}
{"time": "2026-07-27 12:20:09,610", "level": "DEBUG", "module": "pyplot", "message": "Loaded backend Agg version v2.2."}
C:\Users\Dazlah Administrator\Desktop\Forward\Falcon\fasc\Lib\site-packages\django\db\backends\utils.py:98: RuntimeWarning: Accessing the database during app initialization is discouraged. To fix this warning, avoid executing queries in AppConfig.ready() or when your app modules are imported.
  warnings.warn(self.APPS_NOT_READY_WARNING_MSG, category=RuntimeWarning)
{"time": "2026-07-27 12:20:12,500", "level": "INFO", "module": "trace", "message": "Task apps.reportplt.tasks.sync_report_templates[74ab446d-3c5d-4cb9-9f16-8b2c63edd069] succeeded in 0.0930000000007567s: {'status': 'success', 'created': 0}"}
...
/api/v1/admin/tenants/<pk>/map-user/    apps.accounts.api.v1.views.admin.AdminTenantViewSet     admin-tenant-map-user
/api/v1/admin/tenants/<pk>/map-user/\.<format>/ apps.accounts.api.v1.views.admin.AdminTenantViewSet
admin-tenant-map-user
...
/api/v1/admin/users/<pk>/activate/      apps.accounts.api.v1.views.admin.AdminUserViewSet       admin-user-activate
/api/v1/admin/users/<pk>/activate/\.<format>/   apps.accounts.api.v1.views.admin.AdminUserViewSet       admin-user-activate
/api/v1/admin/users/<pk>/deactivate/    apps.accounts.api.v1.views.admin.AdminUserViewSet       admin-user-deactivate
/api/v1/admin/users/<pk>/deactivate/\.<format>/ apps.accounts.api.v1.views.admin.AdminUserViewSet       admin-user-deactivate
...
/api/v1/admin/users/<pk>/map-to-organization/   apps.accounts.api.v1.views.admin.AdminUserViewSet
admin-user-map-to-organization
/api/v1/admin/users/<pk>/map-to-organization/\.<format>/        apps.accounts.api.v1.views.admin.AdminUserViewSet
admin-user-map-to-organization
...
/api/v1/admin/users/<pk>/unlock/        apps.accounts.api.v1.views.admin.AdminUserViewSet       admin-user-unlock
/api/v1/admin/users/<pk>/unlock/\.<format>/     apps.accounts.api.v1.views.admin.AdminUserViewSet       admin-user-unlock
/api/v1/admin/users/<pk>/verify/        apps.accounts.api.v1.views.admin.AdminUserViewSet       admin-user-verify
/api/v1/admin/users/<pk>/verify/\.<format>/     apps.accounts.api.v1.views.admin.AdminUserViewSet       admin-user-verify
/api/v1/admin/users/\.<format>/ apps.accounts.api.v1.views.admin.AdminUserViewSet       admin-user-list
/api/v1/admin/users/bulk-export/        apps.accounts.api.v1.views.admin.AdminUserViewSet       admin-user-bulk-export
/api/v1/admin/users/bulk-export/\.<format>/     apps.accounts.api.v1.views.admin.AdminUserViewSet       admin-user-bulk-export
/api/v1/admin/users/bulk-import/        apps.accounts.api.v1.views.admin.AdminUserViewSet       admin-user-bulk-import
/api/v1/admin/users/bulk-import/\.<format>/     apps.accounts.api.v1.views.admin.AdminUserViewSet       admin-user-bulk-import
...
/api/v1/auth/me/change-password/        apps.accounts.api.v1.views.password.PasswordChangeView  change-password
...
/api/v1/auth/password-reset/    apps.accounts.api.v1.views.password.PasswordResetRequestView    password-reset
/api/v1/auth/password-reset/confirm/    apps.accounts.api.v1.views.password.PasswordResetConfirmView
...
/api/v1/reports/activity-summary/       apps.accounts.api.v1.views.reports.ReportViewSet        report-activity-summary
/api/v1/reports/activity-summary/\.<format>/    apps.accounts.api.v1.views.reports.ReportViewSet        report-activity-summary
/api/v1/reports/audit-trail/    apps.accounts.api.v1.views.reports.ReportViewSet        report-audit-trail
/api/v1/reports/audit-trail/\.<format>/ apps.accounts.api.v1.views.reports.ReportViewSet        report-audit-trail
/api/v1/reports/compliance-summary/     apps.accounts.api.v1.views.reports.ReportViewSet        report-compliance-summary
/api/v1/reports/compliance-summary/\.<format>/  apps.accounts.api.v1.views.reports.ReportViewSet
report-compliance-summary
/api/v1/reports/department-distribution/        apps.accounts.api.v1.views.reports.ReportViewSet
report-department-distribution
/api/v1/reports/department-distribution/\.<format>/     apps.accounts.api.v1.views.reports.ReportViewSet
report-department-distribution
/api/v1/reports/inactive-users/ apps.accounts.api.v1.views.reports.ReportViewSet        report-inactive-users
/api/v1/reports/inactive-users/\.<format>/      apps.accounts.api.v1.views.reports.ReportViewSet        report-inactive-users
/api/v1/reports/login-activity/ apps.accounts.api.v1.views.reports.ReportViewSet        report-login-activity
/api/v1/reports/login-activity/\.<format>/      apps.accounts.api.v1.views.reports.ReportViewSet        report-login-activity
/api/v1/reports/password-changes/       apps.accounts.api.v1.views.reports.ReportViewSet        report-password-changes
/api/v1/reports/password-changes/\.<format>/    apps.accounts.api.v1.views.reports.ReportViewSet        report-password-changes
/api/v1/reports/recently-added/ apps.accounts.api.v1.views.reports.ReportViewSet        report-recently-added
/api/v1/reports/recently-added/\.<format>/      apps.accounts.api.v1.views.reports.ReportViewSet        report-recently-added
/api/v1/reports/role-changes/   apps.accounts.api.v1.views.reports.ReportViewSet        report-role-changes
/api/v1/reports/role-changes/\.<format>/        apps.accounts.api.v1.views.reports.ReportViewSet        report-role-changes
/api/v1/reports/role-distribution/      apps.accounts.api.v1.views.reports.ReportViewSet        report-role-distribution
/api/v1/reports/role-distribution/\.<format>/   apps.accounts.api.v1.views.reports.ReportViewSet        report-role-distribution
/api/v1/reports/suspension-log/ apps.accounts.api.v1.views.reports.ReportViewSet        report-suspension-log
/api/v1/reports/suspension-log/\.<format>/      apps.accounts.api.v1.views.reports.ReportViewSet        report-suspension-log
/api/v1/reports/user-directory/ apps.accounts.api.v1.views.reports.ReportViewSet        report-user-directory
/api/v1/reports/user-directory/\.<format>/      apps.accounts.api.v1.views.reports.ReportViewSet        report-user-directory
...
/api/v1/users/<pk>/verify/      apps.accounts.api.v1.views.user.UserViewSet     user-verify
/api/v1/users/<pk>/verify/\.<format>/   apps.accounts.api.v1.views.user.UserViewSet     user-verify
...
/api/v1/users/bulk-export/      apps.accounts.api.v1.views.user.UserViewSet     user-bulk-export
/api/v1/users/bulk-export/\.<format>/   apps.accounts.api.v1.views.user.UserViewSet     user-bulk-export
/api/v1/users/bulk-import/      apps.accounts.api.v1.views.user.UserViewSet     user-bulk-import
/api/v1/users/bulk-import/\.<format>/   apps.accounts.api.v1.views.user.UserViewSet     user-bulk-import
